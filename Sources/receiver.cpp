...
Receiver::Receiver(Vector3D coordinates_, double critical_energy_, double L_, double amplificaton_coefficient_) :
    coordinates{coordinates_}, critical_energy{critical_energy_}, delay_sum{0}, average_delay{0},
    current_energy{0}, received_signals_count{0}, dist{0}, L{L_}, amplificaton_coefficient{amplificaton_coefficient_} {}
