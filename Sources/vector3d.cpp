...
//g++ -Og -Wall -Wextra -pedantic -Ilib -o Signal_ Sources/object.cpp Sources/radiator.cpp Sources/receiver.cpp Sources/signal.cpp Sources/vector3d.cpp Sources/descrete_maffler.cpp  main.cpp